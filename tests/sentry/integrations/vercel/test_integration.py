...
class VercelIntegrationTest(IntegrationTestCase):
    ...
    def test_update_organization_config(self):
        ...
        random_suffix = self.mock_uuid4.hex
        secret_names = [
        ...
        with patch("sentry.db.mixin.uuid4", new=random_suffix):
    ...
    def test_update_org_config_vars_exist(self):
        ...
        secret_names = [
            "SENTRY_ORG_42",
            "SENTRY_PROJECT_42",
            "NEXT_PUBLIC_SENTRY_DSN_42",
            "SENTRY_AUTH_TOKEN_42",
        ]
        env_var_names = [
            "SENTRY_ORG",
            "SENTRY_PROJECT",
